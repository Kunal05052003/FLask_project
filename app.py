...
# tasks = [
#     {'id': 1, 'title': 'Task 1', 'description': 'Description for Task 1', 'time': '10:00 AM', 'pro': False},
#     {'id': 2, 'title': 'Task 2', 'description': 'Description for Task 2', 'time': '02:30 PM', 'pro': True},
# ]
...
# app = Flask(__name__)
# CORS(app)
# app.config['STRIPE_PUBLIC_KEY'] = 'pk_test_51ORgtSSCCAPHVW4G3wOr5vYTTyhQNFtp5Za20W2xyR3DJT6FQaPqY1E6ymNUNUFGjNmjhOCH7ZFc1tyO5P4KxMRu0003jPGqgX'  # Replace with your actual Stripe public key
# app.config['STRIPE_SECRET_KEY'] = 'sk_test_51ORgtSSCCAPHVW4GwwV5uNiE6kTov1Aj1e5cYpjLEHjV2E5YnIVCIdAa1EUbWI8TkMv6nL0feSbnTknJJ33pML0Y00PkC6ge92'  # Replace with your actual Stripe secret key
...
# class ProLicense(graphene.Mutation):
#     success = graphene.Boolean()

#     def mutate(self, info):
#         # In a real scenario, you'd integrate with Stripe to create a payment session
#         # Here, we'll simulate a successful payment
#         return ProLicense(success=True)
